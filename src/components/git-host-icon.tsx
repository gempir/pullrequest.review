...
export function GitHostIcon({ host, className }: { host: GitHost; className?: string }) {
    if (host === "github") {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 25 25" aria-hidden="true" role="img" className={cn("size-3.5 text-foreground", className)}>
                <title>GitHub</title>
                <path
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" aria-hidden="true" role="img" className={cn("size-3.5", className)}>
            ...
            <defs>
                ...
                >
                    <stop offset=".176" stopColor="var(--host-bitbucket-accent)" />
                    <stop offset="1" stopColor="var(--host-bitbucket)" />
                </linearGradient>
            </defs>
            <path
