    ...
    return (
        <DropdownMenu onOpenChange={onOpenChange}>
            <DropdownMenuTrigger asChild>
                <button
                    type="button"
                    className="h-7 min-w-[110px] max-w-[190px] border-0 bg-background px-2 text-[11px] font-mono flex items-center gap-1.5 outline-none transition-colors hover:bg-surface-1 data-[state=open]:bg-surface-1 focus-visible:ring-0"
