        ...
        <div className="w-full max-w-full" data-component="diff-list-view">
            {prData ? (
                <div
                    ...
                    className={cn("w-full max-w-full border border-l-0 border-t-0 border-border bg-card", isSummaryCollapsedInAllMode && "border-b-0")}
                    style={{ borderTopWidth: 0 }}
                >
                    <div
                        className={cn(
                            "group sticky top-0 z-20 h-10 min-w-0 border-b border-border bg-chrome px-2 flex items-center gap-2 overflow-hidden text-[12px]",
                        )}
                    >
                    ...
                    >
                        ...
                        >
                            <div className="min-w-0 flex flex-1 items-center gap-1">
                                <button
                                    type="button"
                                    className="min-w-0 flex items-center gap-2 overflow-hidden text-left"
