...
type PendingStorageOperation = { type: "set"; key: string; value: string } | { type: "remove"; key: string };
    ...
    storageFlushPromise = (async () => {
        ...
        while (pendingOperations.length > 0) {
            ...
            if (operation.type === "set") {
                ...
                if (existing) {
                    const updateTransaction = storageCollection.update(operation.key, (draft) => {
